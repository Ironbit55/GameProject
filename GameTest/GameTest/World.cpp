...
void World::initialise(){
	...
	GLuint floorTileTexture = SOIL_load_OGL_texture(TEXTUREDIR"floortile.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, 0);


	SimpleTransform transform(60.0f, 600.0f, 50.0f, 50.0f, -90.0f);
	SpriteRenderable sprite1 = SpriteRenderable(dragonTexture, -200.0f, Vector4(1.0f, 0.0f, 0.0f, 1.0f));
	...
	SpriteRenderable sprite2 = SpriteRenderable(raiderTexture , -200.0f, Vector4(0.0f, 1.0f, 0.0f, 1.0f));
	...
	SpriteRenderable tileSprite = SpriteRenderable(floorTileTexture);
	...
	for (int i = 0; i < numSprites; ++i) {
		...
		if (i % 2 == 0) {
			sprite = SpriteRenderable(dragonTexture, -100.0f, Vector4(1.0f, 0.0f, 0.0f, 1.0f));
		} else {
			sprite = SpriteRenderable(dragonTexture, -100.0f, Vector4(1.0f, 0.0f, 0.0f, 1.0f));
		}
