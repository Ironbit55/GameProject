...
SdlInput::SdlInput(SdlInputManager& inputManager) : inputManager(inputManager){
	...
	inputManager.addSdlGameControllerButtonMapping(SDL_GameControllerButton::SDL_CONTROLLER_BUTTON_A, InputRaw::Buttons::BUTTON_CONTROLLER_BUTTON_A);
	inputManager.addSdlGameControllerButtonMapping(SDL_GameControllerButton::SDL_CONTROLLER_BUTTON_B, InputRaw::Buttons::BUTTON_CONTROLLER_BUTTON_B);
	inputManager.addSdlGameControllerButtonMapping(SDL_GameControllerButton::SDL_CONTROLLER_BUTTON_X, InputRaw::Buttons::BUTTON_CONTROLLER_BUTTON_X);
	inputManager.addSdlGameControllerButtonMapping(SDL_GameControllerButton::SDL_CONTROLLER_BUTTON_Y, InputRaw::Buttons::BUTTON_CONTROLLER_BUTTON_Y);
